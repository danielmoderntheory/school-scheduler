...
export interface ClassSnapshot {
  ...
  subject_requires_double_periods?: boolean // legacy snapshots only; superseded by double_periods
  double_periods?: boolean // per-class double periods (authoritative)
